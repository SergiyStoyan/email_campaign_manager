var Cliver = {	
	...
	ShowDialog: function(definition) {
	    ...
	    var html = '<div><div class="_loading" style="height:100%;width:100%;position:absolute;z-index:10;display:none;"><img src="' + Cliver.ProcessingImageSrc + '" style="display:block;margin:auto;position:relative;top:50%;transform:translateY(-50%);"/></div></div>';
	    var e = $(html);
